...
// 태그 내부 내용 변경
// innerHTML : 태그 사용 가능
// innerText, textContent : 태그가 문자(기호)그대로 노출
...
// - 둘 모두 텍스트를 추가한다.
// # 차이점
// innerText = HTML 태그를 해석하지 X, 화면에 보여지는 텍스트대로 처리
// textContent = HTML 태그를 포함하여 처리, 내가 쓴 HTML 문장대로 처리
// => display : none 을 적용하면?
//    - innetText는 없어진 그대로 반환
//    - textContent는 내가 쓴 코드대로 노출하기 때문에 없어진 글자도 반환해줌
...
const list = document.querySelectorAll("ul > li"); // li 유사 배열
// console.log(list);
...
p2.innerHTML = "p2"; // p2 글자 넣기
p3.innerHTML = "p3"; // p3 글자 넣기
