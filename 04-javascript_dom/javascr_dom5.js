...
// addEcentListener (이벤트 종류, 이벤트가 발생했을 때 일어날 일 함수로 작성)
...
function changeColor() {
    ...
    // btn2를 눌렸을 때 생긴 #container안의 div들 ("HI!!!!!!!!!!")
    console.log(divs); // btn 2를 누르지 않았으면 실행 안됨
    for (let div of divs) {
        div.style.backgroundColor = "skyblue"; // btn 2를 누르지 않았으면 실행 안됨
    }
}
